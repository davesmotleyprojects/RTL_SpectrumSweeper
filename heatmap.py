...
/*
    ...
    This is an adaptation of the heatmap.py file from
    https://github.com/keenerd/rtl-sdr-misc
    Thank you Kyle for creating the foundation for future works. 
...
def build_parser():
    ...
    parser.add_argument('--nolabels', dest='nolabels', default=False,
        help='Set to disable the creation of Freq and Time tick labels')
    return parser
...
def labels_parse(s):
    global do_not_add_labels
    if s == 0:
        return False
    else:
        do_not_add_labels = True
        return True
...
def prepare_args():
    ...
    reparse(args, 'nolabels', labels_parse)
